...
pygame.display.set_caption("Binary Tree Traversal Game (Postorder)")
...
def game_loop():
    ...
    # Choose a traversal type (Postorder in this case)
    traversal_sequence = []
    ...
    while running:
        ...
        # Display instruction
        instruction = FONT.render(f"Click nodes in Postorder: {traversal_sequence}", True, BLACK)
