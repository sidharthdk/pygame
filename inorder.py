...
pygame.display.set_caption("Binary Tree Traversal Game (Inorder)")
...
def game_loop():
    ...
    # Choose a traversal type (Inorder in this case)
    traversal_sequence = []
    ...
    while running:
        ...
        # Display instruction
        instruction = FONT.render(f"Click nodes in Inorder: {traversal_sequence}", True, BLACK)
